...
predictors <- tribble(
  ...
  "TUB", "r_TUB", "A6–A9 · tuberculum-konstruktum (0–1)",      "A6–A9 tuberculum ↑",    "Alsó állcsont",  "folytonos",  "feszes, fedett, stabil, jó alakú",    "feszes ínnyel nem fedett, plicaszerű, mozgékony",     0.98, "Stabil, fedett tuberculum → hatásos megtámasztás.",
